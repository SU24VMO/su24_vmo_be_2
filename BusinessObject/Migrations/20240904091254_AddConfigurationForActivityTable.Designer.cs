...
namespace BusinessObject.Migrations
{
    ...
    [Migration("20240904091254_AddConfigurationForActivityTable")]
    partial class AddConfigurationForActivityTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BusinessObject.Models.ActivityStatementFile", b =>
                {
                    b.Property<Guid>("ActivityStatementFileId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("ActivityStatementFileId");

                    b.HasIndex("ActivityId");

                    b.ToTable("ActivityStatementFile", (string)null);
                });
            ...
            modelBuilder.Entity("BusinessObject.Models.ProcessingPhaseStatementFile", b =>
                {
                    b.Property<Guid>("ProcessingPhaseStatementFileId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("ProcessingPhaseStatementFileId");

                    b.HasIndex("ProcessingPhaseId");

                    b.ToTable("ProcessingPhaseStatementFile", (string)null);
                });
            ...
            modelBuilder.Entity("BusinessObject.Models.ProcessingPhaseStatementFile", b =>
                {
                    b.HasOne("BusinessObject.Models.ProcessingPhase", "ProcessingPhase")
                        .WithMany("ProcessingPhaseStatementFiles")
                        .HasForeignKey("ProcessingPhaseId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("BusinessObject.Models.ProcessingPhase", b =>
                {
                    ...
                    b.Navigation("ProcessingPhaseStatementFiles");
                });
