...
namespace SU24_VMO_API.Controllers.VMOControllers
{
    ...
    public class ProcessingPhaseController : ControllerBase
    {
        ...
        [HttpGet]
        [Route("tier-ii/active-status/create-by/organization-manager/{organizationManagerId}")]
        public IActionResult GetProcessingPhaseActiveTierIIByOMId(Guid organizationManagerId, int? pageSize, int? pageNo, string? orderBy, string? orderByProperty)
        {
            try
            {
                var processingPhases = _processingPhaseService.GetProcessingPhaseActiveTierIIByOMId(organizationManagerId);
        ...
        [HttpGet]
        [Route("tier-ii/unactive-status/create-by/organization-manager/{organizationManagerId}")]
        public IActionResult GetProcessingPhaseUnActiveTierIIByOMId(Guid organizationManagerId, int? pageSize, int? pageNo, string? orderBy, string? orderByProperty)
        {
            try
            {
                var processingPhases = _processingPhaseService.GetProcessingPhaseUnActiveTierIIByOMId(organizationManagerId);
        ...
        public IActionResult GetProcessingPhaseActiveTierIIByMemberId(Guid volunteerId, int? pageSize, int? pageNo, string? orderBy, string? orderByProperty)
        {
            try
            {
                var processingPhases = _processingPhaseService.GetProcessingPhaseActiveTierIIByMemberId(volunteerId);
        ...
        [HttpGet]
        [Route("tier-ii/unactive-status/create-by/volunteer/{volunteerId}")]
        public IActionResult GetProcessingPhaseUnActiveTierIIByMemberId(Guid volunteerId, int? pageSize, int? pageNo, string? orderBy, string? orderByProperty)
        {
            try
            {
                var processingPhases = _processingPhaseService.GetProcessingPhaseUnActiveTierIIByMemberId(volunteerId);
        ...
        [HttpGet]
        [Route("tier-ii")]
        public IActionResult GetProcessingPhaseResponseForCampaignTierII(int? pageSize, int? pageNo, string? orderBy, string? orderByProperty)
        {
            try
            {
                var processingPhases = _processingPhaseService.GetProcessingPhaseResponseForCampaignTierII(pageSize, pageNo);
        ...
        [HttpPut("tier-ii/status/update")]
        //[Authorize(Roles = "Volunteer, OrganizationManager, Moderator")]
        public IActionResult UpdateProcessingPhaseToNextProcessingPhaseOfCampaignTierII(UpdateProcessingPhaseStatusRequest request)
        {
            try
            {
                _processingPhaseService.UpdateProcessingPhaseToNextProcessingPhaseOfCampaignTierII(request);
                var response = new ResponseMessage()
                {
                    Message = "Update successfully!",
                };
