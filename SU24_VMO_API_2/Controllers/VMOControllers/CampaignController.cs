...
namespace SU24_VMO_API.Controllers.VMOControllers
{
    ...
    public class CampaignController : ControllerBase
    {
        ...
        [HttpGet]
        [Route("all/number-of-campaign")]
        public IActionResult CalculateNumberOfCampaignActive()
        {
            try
            {
                var number = _campaignService.CalculateNumberOfCampaignActive();
        ...
        public IActionResult GetAllCampaignResponsesByCampaignTypeIdWithStatus(Guid? campaignTypeId, int pageSize, int pageNo, string? status, string? campaignName, string? createBy, string? orderBy, string? orderByProperty)
        {
            try
            {
                var campaigns = _campaignService.GetAllCampaignResponsesByCampaignTypeIdWithStatus(campaignTypeId, status, campaignName, createBy, pageNo, pageSize);
        ...
        [HttpGet]
        [Route("all/filter/tier-II/active-status")]
        public IActionResult GetAllCampaignsTierIIWithActiveStatus(int? pageSize, int? pageNo, string? orderBy, string? orderByProperty)
        {
            try
            {
                var campaigns = _campaignService.GetAllCampaignsTierIIWithActiveStatus();
        ...
        [HttpGet]
        [Route("tier-ii/create-by/organization-manager/{organizationManagerId}")]
        public IActionResult GetAllCampaignTierIICreateByOrganizationManagerId(Guid organizationManagerId, int? pageSize, int? pageNo, string? orderBy, string? orderByProperty, string? campaignName)
        {
            try
            {
        ...
        public IActionResult GetAllCampaignByCreateByVolunteerId(Guid memberId, int? pageSize, int? pageNo, string? orderBy, string? orderByProperty, string? campaignName)
        {
            try
            {
                var campaigns = _campaignService.GetAllCampaignByCreateByVolunteerId(memberId, campaignName, pageSize, pageNo);
        ...
        [HttpGet]
        [Route("tier-ii/create-by/volunteer/{memberId}")]
        public IActionResult GetAllCampaignTierIIByCreateByVolunteerId(Guid memberId, int? pageSize, int? pageNo, string? orderBy, string? orderByProperty, string? campaignName)
        {
            try
            {
                var campaigns = _campaignService.GetAllCampaignTierIIByCreateByVolunteerId(memberId, campaignName, pageSize, pageNo);
        ...
        public IActionResult GetAllCampaignByCreateByVolunteerIdWithOptionsPhaseInProcessingPhase(Guid memberId, int? pageSize, int? pageNo, string? phase, string? orderBy, string? orderByProperty, string? campaignName)
        {
            try
            {
                var campaigns = _campaignService.GetAllCampaignByCreateByVolunteerIdWithOptionsPhaseInProcessingPhase(memberId, phase, campaignName, pageSize, pageNo);
        ...
        [HttpPost]
        [Route("report-campaign/send-email")]
        //[Authorize(Roles = "Moderator")]
        public async Task<IActionResult> SendEmailforReportCampaign(SendEmailForReportCampaignRequest request)
        {
            try
            {
                _campaignService.SendEmailforReportCampaign(request.CampaignId);
        ...
        [HttpPut("update/report-campaign")]
        [Authorize(Roles = "Moderator")]
        public IActionResult UpdateReportCampaign(UpdateReportCampaignRequest request)
        {
            try
            {
                _campaignService.UpdateReportCampaign(request);
                var response = new ResponseMessage()
                {
                    Message = "Update successfully!",
                };
