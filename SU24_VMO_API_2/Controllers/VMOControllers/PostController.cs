...
namespace SU24_VMO_API.Controllers.VMOControllers
{
    ...
    public class PostController : ControllerBase
    {
        ...
        private readonly PaginationService<PostResponse> _paginationService;
        private readonly PaginationService<Post> _paginationService2;



        public PostController(PostService postService, PaginationService<PostResponse> paginationService, PaginationService<Post> paginationService2)
        {
        ...
        [HttpGet]
        [Route("all")]
        public IActionResult GetAllPosts(int? pageSize, int? pageNo, string? orderBy, string? orderByProperty)
        {
            try
            {
                ...
                var response = new ResponseMessage()
                {
                    ...
                    Data = _paginationService2.PaginateList(posts, pageSize, pageNo, orderBy, orderByProperty)
                };
        ...
        [HttpGet]
        [Route("all/active")]
        public IActionResult GetAllPostsActive(int? pageSize, int? pageNo, string? orderBy, string? orderByProperty)
        {
            try
            {
                var posts = _postService.GetAllPostsIsActive();
        ...
        public IActionResult GetAllPostsWithPostTitle(int? pageSize, int? pageNo, string? orderBy, string? orderByProperty, string? title)
        {
            try
            {
                var posts = _postService.GetAllPostsWithPostTitle(title);
        ...
        public IActionResult GetAllPostsOrganizationManagerId(Guid organizationManagerId, int? pageSize, int? pageNo, string? orderBy, string? orderByProperty, string? title)
        {
            try
            {
        ...
        [HttpGet]
        [Route("{postId}")]
        public IActionResult GetAllPostsOrganizationManagerId(Guid postId)
        {
            try
            {
