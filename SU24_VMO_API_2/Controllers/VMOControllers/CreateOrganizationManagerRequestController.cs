...
namespace SU24_VMO_API.Controllers.VMOControllers
{
    ...
    public class CreateOrganizationManagerRequestController : ControllerBase
    {
        ...
        public IActionResult GetAllCreateOrganizationManagerRequests(int? pageSize, int? pageNo, string? orderBy, string? orderByProperty)
        {
            try
            {
        ...
        [HttpGet]
        [Route("{createOrganizationManagerRequestId}")]
        [Authorize(Roles = "OrganizationManager, Volunteer, Moderator, Member, Admin")]
        public IActionResult GetCreateOrganizationManagerRequestById(Guid createOrganizationManagerRequestId)
        {
            try
            {
                var request = _service.GetCreateOrganizationManagerRequestById(createOrganizationManagerRequestId);
        ...
        public IActionResult GetAllCreateOrganizationManagerRequestsByOrganizationManagerName(int? pageSize, int? pageNo, string? orderBy, string? orderByProperty, string? organizationManagerName)
        {
            try
            {
                var requests = _service.GetAllCreateOrganizationManagerRequestsByOrganizationManagerName(organizationManagerName, pageSize, pageNo);
                var response = new ResponseMessage()
                {
                    Message = "Get successfully!",
                    Data = requests
        ...
        [HttpPut]
        [Authorize(Roles = "Moderator, OrganizationManager")]
        [Route("update/status")]

        public IActionResult UpdateStatusCreateOrganizationManagerVerifiedRequest(UpdateStatusCreateOrganizationManagerVerifiedRequest request)
        {
            try
            {
                _service.UpdateStatusCreateOrganizationManagerVerifiedRequest(request);
        ...
        [Route("update/request-information")]

        public IActionResult UpdateCreateOrganizationManagerVerifiedRequest(Guid createOrganizationManagerVerifiedRequestId, UpdateCreateOrganizationManagerVerifiedRequest request)
        {
            try
            {
                _service.UpdateCreateOrganizationManagerVerifiedRequest(createOrganizationManagerVerifiedRequestId, request);
                var response = new ResponseMessage()
                {
                    Message = "Update successfully!",
                };
