...
namespace SU24_VMO_API.Controllers.VMOControllers
{
    ...
    public class CreateActivityRequestController : ControllerBase
    {
        ...
        public IActionResult GetAllCreateActivityRequestsOfCampaignTierI(int? pageSize, int? pageNo, string? orderBy, string? orderByProperty)
        {
            try
            {
        ...
        public IActionResult GetAllCreateActivityRequestsOfCampaignTierII(int? pageSize, int? pageNo, string? orderBy, string? orderByProperty)
        {
            try
            {
        ...
        [HttpPut]
        [Route("tier-ii/update/activity-information")]

        public async Task<IActionResult> UpdateCreateActivityRequestCampaignTierIIRequest(Guid createActivityRequestId, [FromForm] UpdateCreateActivityRequestRequest request)
        {
            try
            {
                await _createActivityRequestService.UpdateCreateActivityRequestCampaignTierIIRequest(createActivityRequestId, request);
