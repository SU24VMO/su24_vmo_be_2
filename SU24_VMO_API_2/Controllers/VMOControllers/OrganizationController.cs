...
namespace SU24_VMO_API.Controllers.VMOControllers
{
    ...
    public class OrganizationController : ControllerBase
    {
        ...
        [HttpGet]
        [Route("all/number-of-organization")]
        public IActionResult CalculateNumberOfOrganizationActive()
        {
            try
            {
                var number = _organizationService.CalculateNumberOfOrganizationActive();
        ...
        public IActionResult UpdateOrganizationRequest(Guid organizationId, [FromForm] UpdateOrganizationRequest request)
        {
            try
            {
                _organizationService.UpdateOrganizationRequest(organizationId, request);
                var response = new ResponseMessage()
                {
        ...
        public IActionResult UpdateStatusOrganization(UpdateOrganizationStatusRequest request)
        {
            try
            {
                _organizationService.UpdateOrganizationStatusRequest(request);
                var response = new ResponseMessage()
                {
                    Message = "Update successfully!",
                };
