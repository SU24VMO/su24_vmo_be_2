...
namespace SU24_VMO_API.Controllers.VMOControllers
{
    ...
    public class TransactionController : ControllerBase
    {
        ...
        [HttpGet]
        [Route("all/recently-receive-transaction")]
        public IActionResult GetAllNumberRecentlyReceiveTransactions(int? pageSize, int? pageNo, string? orderBy, string? orderByProperty, int? numberOfTransaction)
        {
            try
            {
                var transactions = _transactionService.GetAllNumberRecentlyReceiveTransactions(numberOfTransaction);
